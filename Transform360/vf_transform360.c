  ...
  if (s->output_stereo_format == STEREO_FORMAT_GUESS) {
    if (s->input_stereo_format == STEREO_FORMAT_MONO) {
      ...
      s->output_stereo_format =
          (s->output_layout == LAYOUT_CUBEMAP_23_OFFCENTER) ? STEREO_FORMAT_LR
                                                            : STEREO_FORMAT_TB;
    }
  }
...
static const AVOption transform360_options[] = {
    ...
    {"s",
     ...
     0,
     FLAGS},
    {"is_horizontal_offset",
     "Whether to use offset on the horizontal plane only. It only affects yaw.",
     OFFSET(is_horizontal_offset),
     AV_OPT_TYPE_BOOL,
     {.i64 = 0},
     0,
     1,
    ...
    {"max_cube_edge_length",
     ...
     .flags = FLAGS},
    {"max_output_h",
     "Max height of the output video (for pyramid/cone transform, overrides pyramid_height, default 0 for off)",
     OFFSET(max_output_h),
     AV_OPT_TYPE_INT,
     {.i64 = 0},
     0,
     ...
     .flags = FLAGS},
    {"max_output_w",
     "Max width of the output video (for pyramid/cone transform, overrides pyramid_height, default 0 for off)",
     OFFSET(max_output_w),
     AV_OPT_TYPE_INT,
     {.i64 = 0},
     0,
    ...
    {"input_stereo_format",
     ...
     .flags = FLAGS,
     "stereo_format"},
    {"output_stereo_format",
     "Output video stereo format",
     OFFSET(output_stereo_format),
     AV_OPT_TYPE_INT,
     {.i64 = STEREO_FORMAT_GUESS},
     0,
     STEREO_FORMAT_N - 1,
    ...
    {"CUBEMAP_23_OFFCENTER",
     ...
     0,
     AV_OPT_TYPE_CONST,
     {.i64 = LAYOUT_CUBEMAP_23_OFFCENTER},
     0,
     0,
     FLAGS,
     "layout"},
    ...
    {"input_expand_coef",
     "Expansion coeffiecient of the input",
     OFFSET(input_expand_coef),
     AV_OPT_TYPE_FLOAT,
     {.dbl = 1.01f},
     0,
     10,
    ...
    {"vfov",
     ...
     .flags = FLAGS},
    {"cube_offcenter_x",
     "Offcenter cube displacement x",
     OFFSET(fixed_cube_offcenter_x),
     AV_OPT_TYPE_FLOAT,
     {.dbl = 0.0},
     -1,
     1,
     .flags = FLAGS},
    {"cube_offcenter_y",
     "Offcenter cube displacement y",
     OFFSET(fixed_cube_offcenter_y),
     AV_OPT_TYPE_FLOAT,
     {.dbl = 0.0},
     -1,
     1,
     .flags = FLAGS},
    {"cube_offcenter_z",
     "Offcenter cube displacement z",
     OFFSET(fixed_cube_offcenter_z),
     AV_OPT_TYPE_FLOAT,
     {.dbl = 0.0},
     -1,
     1,
    ...
    {"interpolation_alg",
     ...
     "interpolation_alg"},
    {"width_scale_factor",
     "Scale factor of width for antialiasing",
     OFFSET(width_scale_factor),
     AV_OPT_TYPE_FLOAT,
     {.dbl = 1.0},
     0,
     10,
     ...
     "width_scale_factor"},
    {"height_scale_factor",
     "Scale factor of height for antialiasing",
     OFFSET(height_scale_factor),
     AV_OPT_TYPE_FLOAT,
     {.dbl = 1.0},
     0,
     10,
    ...
    {"enable_low_pass_filter",
     "Enable low pass filter-based antialiasing",
     OFFSET(enable_low_pass_filter),
     AV_OPT_TYPE_INT,
     {.i64 = 1},
     0,
     1,
    ...
    {"enable_multi_threading",
     "Enable multi-threading to speed up low pass filter-based antialiasing",
     OFFSET(enable_multi_threading),
     AV_OPT_TYPE_INT,
     {.i64 = 1},
     0,
     1,
     .flags = FLAGS,
     "enable_multi_threading"},
    {"num_vertical_segments",
     "Number of vertical segments per frame plane",
     OFFSET(num_vertical_segments),
     AV_OPT_TYPE_INT,
     {.i64 = 5},
     2,
     500,
     .flags = FLAGS,
     "num_vertical_segments"},
    {"num_horizontal_segments",
     "Number of horizontal segments per frame plane",
     OFFSET(num_horizontal_segments),
     AV_OPT_TYPE_INT,
     {.i64 = 1},
     1,
     500,
     .flags = FLAGS,
     "num_horizontal_segments"},
    {"kernel_height_scale_factor",
     "Factor to scale the calculated kernel height for low pass filtering",
     OFFSET(kernel_height_scale_factor),
     AV_OPT_TYPE_FLOAT,
     {.dbl = 1.0},
     0.1,
     100.0,
     .flags = FLAGS,
     "kernel_height_scale_factor"},
    {"min_kernel_half_height",
     "Half of the mininum kernel height",
     OFFSET(min_kernel_half_height),
     AV_OPT_TYPE_FLOAT,
     {.dbl = 1.0},
     0.5,
     200,
     .flags = FLAGS,
     "min_kernel_half_height"},
    {"max_kernel_half_height",
     "The maximum value of the kernel height",
     OFFSET(max_kernel_half_height),
     AV_OPT_TYPE_FLOAT,
     {.dbl = 10000.0},
     0.5,
     100000,
     ...
     "max_kernel_half_height"},
    {"adjust_kernel",
     "Enable adjustment of kernel",
     OFFSET(adjust_kernel),
     AV_OPT_TYPE_INT,
     {.i64 = 1},
     0,
     1,
     .flags = FLAGS,
     "adjust_kernel"},
    {"kernel_adjust_factor",
     "Factor to further adjust the kernel size",
     OFFSET(kernel_adjust_factor),
     AV_OPT_TYPE_FLOAT,
     {.dbl = 1.0},
     0.1,
     100.0,
